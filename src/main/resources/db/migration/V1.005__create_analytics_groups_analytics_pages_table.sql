...
CREATE UNIQUE NONCLUSTERED INDEX analytics_groups_analytics_pages ON ${flyway:defaultSchema}.analytics_groups_analytics_pages (analytics_group_id, analytics_page_id)
